...
export function useBookings(options?: AutoRefreshOptions) {
  return useQuery({
...
export function useInvoices(options?: AutoRefreshOptions) {
  return useQuery({
...
export function useInvoiceItems(options?: AutoRefreshOptions) {
  return useQuery({
...
export function usePaymentsForInvoice(
  invoiceId: string,
